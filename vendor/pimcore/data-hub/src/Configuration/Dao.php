...
class Dao extends AbstractDao
{
    ...
    {
        $list = self::getList();
        file_put_contents(\Pimcore::getKernel()->getLogDir().'/rajehs_test_log.log',var_export([PIMCORE_CONFIGURATION_DIRECTORY."TEST"],true),FILE_APPEND);
        //p_r($list);exit;
    ...
    public static function getList(): array
    {
        ...
        //p_r($configurations);exit;
        asort($configurations);
        foreach($configurations as $x => $x_value) {
            $sortData[] = $x_value;
          }
        return $sortData;
    }
